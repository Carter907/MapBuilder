...
### Jar Location
- look in `Releases` for the latest release. You will see two different jars: MapBuilder.jar is Java 8 while MapBuilder_17.jar is Java 17. (Jar with the smaller size is Java 8)
