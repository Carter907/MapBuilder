package com.example.mapbuildermodern.screens;

import com.example.mapbuildermodern.AppStart;
import com.example.mapbuildermodern.edit.Cell;
import com.example.mapbuildermodern.util.MapManager;
...
public class Editor extends BorderPane {
    ...
    private Pane initializeRight() {
        ...
        Label beeperSelection = new Label("Beeper", new ImageView(AppStart.class.getResource("assets/Beeper.png").toExternalForm()));
        selectionView.getItems().add(beeperSelection);
        beeperSelection.setAlignment(Pos.CENTER);


        Label horizontalSelection = new Label("Horizontal", new ImageView(AppStart.class.getResource("assets/Horizontal.png").toExternalForm()));
        selectionView.getItems().add(horizontalSelection);
        horizontalSelection.setAlignment(Pos.CENTER);

        Label verticalSelection = new Label("Vertical", new ImageView(AppStart.class.getResource("assets/Vertical.png").toExternalForm()));
        selectionView.getItems().add(verticalSelection);
        verticalSelection.setAlignment(Pos.CENTER);

        Label removeSelection = new Label("Remove", new ImageView(AppStart.class.getResource("assets/Remove.png").toExternalForm()));
        selectionView.getItems().add(removeSelection);
        removeSelection.setAlignment(Pos.CENTER);

        Label freeClickSelection = new Label("Free Click", new ImageView(AppStart.class.getResource("assets/Free_Click.png").toExternalForm()));
