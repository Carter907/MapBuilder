...
public class AppStart extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        title.setFont(Font.font("Cascadia Code", FontWeight.NORMAL, FontPosture.REGULAR, 100));
    ...
    private Pane setAnimation() {
        ...
        ImageView karelSplash = new ImageView("assets/Karel_Splash.png");
        ...
        Image backgroundImage = new Image("assets/background.png");
